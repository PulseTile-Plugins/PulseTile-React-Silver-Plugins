    ...
    return (
      <div className="section-detail">
        <div className="panel-group accordion">
          {(expandedPanel === TEST_RESULT_PANEL || expandedPanel === 'all') && !editedPanel[TEST_RESULT_PANEL] ? <PluginDetailPanel
            onExpand={onExpand}
            name={TEST_RESULT_PANEL}
            title="Test Result"
            onShow={onShow}
            isOpen={openedPanel === TEST_RESULT_PANEL}
